...
async function shareCompareCard(recipeA, recipeB) {
  ...
  el.style.cssText =
    "position:absolute;left:-9999px;top:0;font-family:'DM Sans',Arial,sans-serif;width:420px;background:#FBFBFA;border-radius:16px;box-sizing:border-box;";
  ...
  const canvas = await html2canvas(el, {
    ...
    backgroundColor: "#FBFBFA", logging: false, width: 420, windowWidth: 420,
  });
