...
export const I18N = {
  ko: {
    ...
    gearVault: "Gear Vault", gearVaultSub: "내가 사용하는 장비를 관리해요.",
    coffeeWiki: "Coffee Wiki", coffeeWikiSub: "원두와 장비, 함께 만드는 커피 데이터베이스",
  ...
  en: {
    ...
    gearVault: "Gear Vault", gearVaultSub: "Manage your brewing equipment.",
    coffeeWiki: "Coffee Wiki", coffeeWikiSub: "A community-built coffee bean & equipment database",
